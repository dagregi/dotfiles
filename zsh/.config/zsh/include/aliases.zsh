...
alias searxng='export SEARXNG_PORT=8090; docker run --rm -d -p ${SEARXNG_PORT}:8080 -v "searxng:/etc/searxng" -e BASE_URL=http://localhost:${SEARXNG_PORT} -e INSTANCE_NAME=nemesis-xng --name nemesis-xng searxng/searxng'
